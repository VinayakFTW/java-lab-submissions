...
public class ArrayListForBooks
{
    public static void main(String args[])  {
        ...
        try {
            ...
            Book b2 = new Book("HarryPotter", 3999, "FL0001", "JK Rowling");
            b2.genre = "Fantasy";
            b2.dateOfPub = LocalDate.of(2003, 5, 12);
            alb.add(b2);

            Book b3 = new Book("Hobbit", "Barry Lie", 3490, "GH120");
            b3.dateOfPub = LocalDate.of(1999, 2, 23);
            b3.genre = "Fiction";
            alb.add(b3);

            Book b4 = new Book("Wonder Land", 2345, "TR123", "Yarry Bit");
            b4.genre = "Fiction";
            b4.dateOfPub = LocalDate.of(2008, 11, 2);
            alb.add(b4);
